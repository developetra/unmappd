...
public class SetupActivity extends AppCompatActivity implements GameService.GameServiceListener {
    ...
    /**
     * Listener method when player position is updated by game service. Enables player to set up the game.
     *
     * @param location
     * @author Petra Langenbacher
     */
    ...
    /**
     * Listener method when player reached target - NOT used in this activity.
     *
     * @param endOfGame
     */
